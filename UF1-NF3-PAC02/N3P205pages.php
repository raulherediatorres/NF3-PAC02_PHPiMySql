...
$sSQL = "SELECT * FROM movie WHERE nombre LIKE '%$buskr%' LIMIT ".($pagina-1)*$noRegistros.",$noRegistros";
...
$sSQL = "SELECT count(*) FROM movie WHERE nombre LIKE '$buskr'"; //Cuento el total de registros
